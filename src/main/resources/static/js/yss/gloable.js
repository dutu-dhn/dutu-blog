...
function login() {
    window.name="article";
    window.open("https://api.weibo.com/oauth2/authorize?client_id=3452297360&response_type=code&redirect_uri=http://dutu.cn.utools.club/webLogin");
};
function logout() {
    $.ajax({
        url: "/logout",
...
layui.use(["jquery", "layer", "util"], function () {
    var n = layui.jquery, i = layui.layer, t = layui.util;
    t.fixbar();
    master.start(n)
});
var slider = 0, pathname = window.location.pathname.replace("Read", "Article"), master = {};
master.start = function (n) {
    ...
    n(".blog-user img").hover(function () {
        var n = layer.tips("点击退出", ".blog-user", {tips: [3, "#009688"]})
    }, function () {
        layer.closeAll("tips")
    })
}, function (n, t) {
    ...
    function l(n, i, u) {
        var f;
        return f = t.positionUsing === "translate3d" ? {transform: "translate3d(" + r(n) + "%,0,0)"} : t.positionUsing === "translate" ? {transform: "translate(" + r(n) + "%,0)"} : {"margin-left": r(n) + "%"}, f.transition = "all " + i + "ms " + u, f
    }
    ...
    return n.version = "0.2.0", t = n.settings = {
        ...
        r = f(r, t.minimum, 1);
        n.status = r === 1 ? null : r;
        var u = n.render(!s), h = u.querySelector(t.barSelector), o = t.speed, c = t.easing;
        return u.offsetWidth, e(function (f) {
            t.positionUsing === "" && (t.positionUsing = n.getPositioningCSS());
            i(h, l(r, o, c));
            r === 1 ? (i(u, {transition: "none", opacity: 1}), u.offsetWidth, setTimeout(function () {
                i(u, {transition: "all " + o + "ms linear", opacity: 0});
                setTimeout(function () {
                    n.remove();
                    f()
                }, o)
        ...
        var h = f.querySelector(t.barSelector), l = u ? "-100" : r(n.status || 0), e = document.querySelector(t.parent),
            o;
        return i(h, {
        ...
        function u(t) {
            ...
            if (t in u) return t;
            for (i = n.length, f = t.charAt(0).toUpperCase() + t.slice(1); i--;) if (r = n[i] + f, r in u) return r;
            return t
        }
        ...
        var n = ["Webkit", "O", "Moz", "ms"], t = {};
        return function (n, t) {
            var u = arguments, r, f;
            if (u.length == 2) for (r in t) f = t[r], f !== undefined && t.hasOwnProperty(r) && i(n, r, f); else i(n, u[1], u[2])
        }
    }(), n
})
